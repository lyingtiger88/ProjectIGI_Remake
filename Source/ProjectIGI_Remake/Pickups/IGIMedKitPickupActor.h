...
#include "IGIMedKitPickupActor.generated.h"

class UPrimitiveComponent;
class USphereComponent;
class UStaticMeshComponent;

UCLASS(Blueprintable, BlueprintType, meta = (DisplayName = "IGI Med Kit Pickup"))
class PROJECTIGI_REMAKE_API AIGIMedKitPickupActor : public AActor
{
    GENERATED_BODY()

public:
    AIGIMedKitPickupActor();
